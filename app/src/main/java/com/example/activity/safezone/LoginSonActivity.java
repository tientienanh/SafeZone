    ...
    public void onClick(View view) {
        if (isNetworkAvailable(LoginSonActivity.this) == false) {
            ...
            if (child_user.equals("") || parentUser_in_child.equals("") || parentPass_in_child.equals("")) {
                ...
                queryByUser.queryByuser("ParentAccount", RegisterActivity.USERNAME, parentUser_in_child, new QueryByUser.QueryByUserCallBack() {
                    @Override
                    public void queryByUserSuccess(ParseObject parseObject) {
                        String parentName = parseObject.getString(RegisterActivity.USERNAME);
                        final String parentPass = parseObject.getString(RegisterActivity.PASS);
